...
![Home](Screenshots/Screenshot%20%2826%29.png)
...
![Executive Dashboard](Screenshots/Screenshot%20%2827%29.png)
...
![Agriculture Intelligence](Screenshots/Screenshot%20%2828%29.png)
...
![Education Intelligence](Screenshots/Screenshot%20%2829%29.png)
...
![Rainfall Intelligence](Screenshots/Screenshot%20%2830%29.png)

![District Profile](Screenshots/Screenshot%20%2831%29.png)

---

## 🗂️ Data Model

The project uses a dimensional analytical structure with a central district dimension and multiple fact tables.

### Dimension Table

**DimDistrict**

Contains district-level master information used to connect the analytical datasets.
...
Documentation includes materials such as:
...
│   └── Screenshot (31).png
│
└── BDDIP_README_Portfolio_Case_Study.md
```

> The Power BI project file is intentionally not included in the public repository. The repository focuses on the portfolio presentation, documentation, screenshots, and analytical methodology.
...
The screenshots demonstrate the final report layout and the type of interactive analysis available in the original Power BI report.
